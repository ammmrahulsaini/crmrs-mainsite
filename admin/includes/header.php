...
.admin-navbar .navbar-top-links > li > a,
...
.admin-navbar .navbar-top-links > li > a:hover {
    color: #fff !important;
...
.navbar-default.sidebar {
    background: linear-gradient(135deg, #100f0c 40%, #5a574f 100%);
    border-right: none;
}
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php if (isset($_SESSION['user_logged_in']) && $_SESSION['user_logged_in'] == true): ?>
                <nav class="navbar navbar-default navbar-static-top admin-navbar" role="navigation" style="margin-bottom: 0">                    <div class="navbar-header">
                        ...
                        <div class="sidebar-nav navbar-collapse">
                            <ul class="nav" id="side-menu">
                                ...
                                <li <?php echo (CURRENT_PAGE == "customers.php" || CURRENT_PAGE == "add_customer.php") ? 'class="active"' : ''; ?>>
                                    <a href="#"><i class="fa fa-user-circle fa-fw"></i> Job Openings<span class="fa arrow"></span></a>
